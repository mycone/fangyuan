...
namespace app\modules\system\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use app\modules\system\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\common\modules\menu\models\Menu]].
 * 
